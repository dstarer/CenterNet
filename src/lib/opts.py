...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--dataset', default='coco',
                                 help='coco | kitti | coco_hp | pascal | plusai')
        self.parser.add_argument('--data_dir', default='.', help='dataset home')
        ...
        self.parser.add_argument('--output', default='', help='path to save detection result under data_dir')
        # system
    ...
    def update_dataset_info_and_set_heads(self, opt, dataset):
        ...
        print("update dataset info and set heads ", dataset.num_classes)
